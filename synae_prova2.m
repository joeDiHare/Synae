...
I=imread('C:\Users\sc04\Pictures\pers_varie\syn2.png');
I2=double(I(:,:,1))./255; % I2=imresize(I2,[300 200]);%imshow(I2)
MASK=I2(end:-1:1,:);

% apply the ideal binary mask and create modified complex spectrum
spectrum.Y = abs(spectrum.X) .* MASK .* exp(1i*angle(spectrum.X));
